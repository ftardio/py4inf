...
\section{Recibiendo una imagen mediante HTTP}
...
\section{Recibiendo páginas web con {\tt urllib}}
...
Cuando el programa se ejecuta, sólo obtenemos la
...
usar toda la memoria que tenga el ordenador.
...
que quieras usar realmente este patrón en algún programa que estés escribiendo.
...
\item[araña:] La acción de un motor de búsqueda web de recuperar una página
