...
Hasta el momento, primero hemos aprendido el lenguaje Python y luego
...
Aquí tenemos un ejemplo de ejecución una vez que ya disponemos de información almacenada en la
base de datos:
...
El primero y más simple análisis de datos consistirá en determinar ``¿quién ha enviado más correos?'',
