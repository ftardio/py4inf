...
En primer lugar nos centraremos en leer y escribir archivos de texto,
...
Cuando se buscan datos dentro de un archivo, un
...
\section{Dejando al usuario elegir el nombre del archivo}
