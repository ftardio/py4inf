...
contiene actualmente el archivo, sino que se trata de un ``manejador (handle)'' que se
...
Por ejemplo, esta es una muestra de un fichero de texto que guarda la actividad de correos
...
\afterverb
%
Cuando los programas de procesado de archivos se van volviendo más complejos, es posible
...
\begin{verbatim}
python search6.py 
Introduce el nombre del fichero: missing.txt
Traceback (most recent call last):
